...
<div>
    ...
    >
            <v-list-item>
                ...
                <v-list-item-content>
                    <v-list-item-title> <span class="white--text">Layanan</span></v-list-item-title>
                </v-list-item-content>
                </v-list-item>
                ...
                <v-list-item @click="$router.push('/pegawai')">
                <v-list-item-action>
                    <v-icon color="white">mdi-check-bold</v-icon>
                </v-list-item-action>
                <v-list-item-content>
                    <v-list-item-title> <span class="white--text">Pegawai</span></v-list-item-title>
                </v-list-item-content>
                </v-list-item>
                ...
                <v-list-item-content>
                    <v-list-item-title> <span class="white--text">Supplier</span></v-list-item-title>
                </v-list-item-content>
                </v-list-item>

                <v-list-item @click="$router.push('/hewan')">
                <v-list-item-action>
                    <v-icon color="white">mdi-check-bold</v-icon>
                </v-list-item-action>
                <v-list-item-content>
                ...
                <v-list-item @click="$router.push('/jenishewan')">
                <v-list-item-action>
                    <v-icon color="white">mdi-check-bold</v-icon>
                </v-list-item-action>
                <v-list-item-content>
                    <v-list-item-title> <span class="white--text">Jenis Hewan</span></v-list-item-title>
                </v-list-item-content>
                </v-list-item>

                <v-list-item @click="$router.push('/ukuranhewan')">
                <v-list-item-action>
                    <v-icon color="white">mdi-check-bold</v-icon>
                </v-list-item-action>
                <v-list-item-content>
                ...
                <v-list-item @click="$router.push('/owner/penjualanproduk')">
                <v-list-item-action>
                    <v-icon color="white">mdi-check-bold</v-icon>
                    </v-list-item-action>
                    <v-list-item-content>
                ...
                <v-list-item @click="$router.push('/owner/penjualanlayanan')">
                <v-list-item-action>
                    <v-icon color="white">mdi-check-bold</v-icon>
                    </v-list-item-action>
                    <v-list-item-content>
